...
| `<guid>_exploit_research.json` | **Exploit Research panel** — faulting insn + static EA reconstruction + register/input matrix + write-control split + next experiment; stamped with `engine` build identity |
