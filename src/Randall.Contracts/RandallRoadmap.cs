...
public static class RandallRoadmap
{
    ...
    [
        ...
        [
            ...
            new("p8-magician", "Magician engine — spells + summons (knight/army/bots/hunter/joker)", true, "docs/MAGICIAN.md"),
            new("p8-joker", "Joker — chaotic random tricks; Magician watches & capitalizes", true, "docs/MAGICIAN.md#joker"),
            new("p8-reeldeck", "ReelDeck media file target + path stalking maturity lab", true, "docs/REELDECK.md"),
            new("p8-path-stalk", "Cooperative path novelty for file targets (REELDECK_PATHLOG)", true, "docs/REELDECK.md"),
            ...
            new("p8-ai-seed", "Optional AI seed / dictionary recipes", true, "docs/AI_SEED.md"),
        ]),
        ...
        [
            ...
            new("p25-bench-sample", "Checked-in sample bake-off SUMMARY", true, "docs/bench-samples/SAMPLE_SUMMARY.md"),
            new("p25-pack-rid", "RID-aware portable pack + release notes", true, "docs/RELEASE.md"),
            new("p25-attr-fixture", "Attribution eval fixture", true, "examples/ai-code-sample"),
            new("p25-response-class", "Oracle expect/forbid response class", true, "docs/ORACLES.md"),
            new("p25-tests", "Automated unit/integration tests", false, "tests/Randall.Tests + Linux CI"),
            new("p25-cookie-jar", "HTTP cookie jar stub", true, "docs/WEB_FUZZ.md"),
            new("p25-doctor-hints", "Doctor project-aware build hints", true, null),
            new("p25-bench-numbers", "Published quiet-box bake-off numbers", false, "longer BUDGET + edges"),
