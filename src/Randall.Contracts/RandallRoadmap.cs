...
public static class RandallRoadmap
{
    ...
    [
        ...
        [
            ...
            new("p18-stream", "Import TCP stream / app payload → steps", false, "not full pcap dissect"),
            new("p18-presets", "More network presets (SMTP, Redis, custom binary)", false, null),
            new("p18-docs", "Docs: fuzz remote TCP from Scare Floor", true, "docs/CASE_BUILDER.md"),
        ]),
        new(19, "Wire Scare Floor ↔ sessions/models", "planned",
        [
            new("p19-flows", "Save recipe → sessionFlows / sessionCommands", true, "Apply to Campaign (Phase 18)"),
            new("p19-graph-edit", "Edit sessionGraph edges in web UI", false, "Phase 14 viewer → editor"),
            new("p19-expect", "expectResponse per step in Scare Floor", false, null),
            new("p19-promote", "Promote steps → projects/protocols model YAML", false, "docs/MODEL.md"),
            new("p19-dict", "Dictionary harvest across session steps", false, null),
            new("p19-cli", "randall case from-proxy / from-stream", false, null),
        ]),
        new(20, "Protocol packs", "planned",
        [
            new("p20-format", "Pack format: recipe + protocol YAML + example project", false, "projects/protocols/packs/"),
            new("p20-http", "HTTP/1.1 request pack (headers as fields)", false, null),
            new("p20-ftp", "FTP login → STOR/RETR flow pack", false, null),
            new("p20-tlv", "Generic TLV / length-prefixed pack", false, null),
