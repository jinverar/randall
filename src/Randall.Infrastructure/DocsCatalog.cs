...
public static class DocsCatalog
{
    ...
    [
        ...
        ("STALK_MAP.md", "In-Randall stalk map (strings / imports / missed)", "Getting started"),
        ...
        ("DEFENSE_LAB.md", "Defense-shaped UAS / sentry labs (UAS1 / STT1)", "Lab"),
        ...
        ("EXPLOIT_GUIDE.md", "Scream triage — offsets + ROP Studio", "Stalk & scream"),
        ("WINDBG_FUZZ_PKG.md", "Scream Walk · ROP Studio · RandfuzzDbg/Gdb", "Stalk & scream"),
        ...
        ("RPC_LAB.md", "RPC / DCE-shaped lab", "Lab"),
        ("SMB_LAB.md", "SMB-shaped lab", "Lab"),
